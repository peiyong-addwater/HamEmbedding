...
res_file_list = ["20230510-134752_siamese-10-class-qiskit-mnist-3x3-conv-classical-features-tiny-image-results-2-img_per_class-COBYLA.json",
                 ...
                 "20230520-163129_siamese-10-class-qiskit-mnist-3x3-conv-classical-features-tiny-image-results-4-img_per_class-ADAM-SPSA.json"]
...
plt.axvline(x=1000+1000+1000+1000+500-1, linestyle='--', label = "0520", color = 'y')
plt.xlabel('iterations')
plt.ylabel('contrastive loss (classical measurement as features)')
plt.legend()
plt.savefig("losses_until_230524_file.png")