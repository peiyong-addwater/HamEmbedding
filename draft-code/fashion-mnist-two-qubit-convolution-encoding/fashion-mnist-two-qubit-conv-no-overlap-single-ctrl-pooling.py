...
if __name__ == '__main__':
    ...
    plt.savefig("circuit-su4-encoding-no-overlap-multiclass.pdf")
    ...
    plt.savefig(f"fashion-mnist-4class-su4-encoding-no-overlap-kernel-{KERNEL_SIZE[0]}-stride{STRIDE[0]}-results-{n_test}-test-{n_reps}-reps.pdf")
