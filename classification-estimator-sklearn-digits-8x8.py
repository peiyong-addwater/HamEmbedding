...
from Models.qiskit_models import ClassificationEstimatorQNN8x8Image
...
if __name__ == '__main__':
    ...
    parser.add_argument('--spsa_batchsize', type=int, required=False, default=100)
    ...
    num_total_qubits = N_MEM_QUBITS + 3

    OBSERVABLE_STRINGS = [
        "XIII" + 'I' * (num_total_qubits - 4),
        "IXII" + 'I' * (num_total_qubits - 4),
        "IIXI" + 'I' * (num_total_qubits - 4),
        "IIIX" + 'I' * (num_total_qubits - 4),
        "ZIII" + 'I' * (num_total_qubits - 4),
        "IZII" + 'I' * (num_total_qubits - 4),
        "IIZI" + 'I' * (num_total_qubits - 4),
        "IIIZ" + 'I' * (num_total_qubits - 4),
        "YIII" + 'I' * (num_total_qubits - 4),
        "IYII" + 'I' * (num_total_qubits - 4)
    ]

    OBSERVABLES = [
        SparsePauliOp(c) for c in OBSERVABLE_STRINGS
    ]
    ...
    model_hyperparams = {
        ...
        "observables": OBSERVABLE_STRINGS
    }
    ...
    model = ClassificationEstimatorQNN8x8Image(
