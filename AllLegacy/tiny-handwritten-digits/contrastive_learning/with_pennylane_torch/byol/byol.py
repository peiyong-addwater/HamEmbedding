"""
Based on https://github.com/lucidrains/byol-pytorch/blob/master/byol_pytorch/byol_pytorch.py
Didn't just install the original package off-the-shelf because some modifications might be needed.
"""
import copy
import random
...
def loss_fn(x, y):
    ...
    return 2 - 2 * (x * y).sum(dim=-1) # dot product
