...
from Models.non_rnn_models_qiskit import ClassificationSamplerFullyQuantumFFQNN8x8Image
...
if __name__ == '__main__':
    ...
    task_name = 'classification-sklearn-digits-8x8-samplerResetPooling-QFFN-FullQuantum-4x4-patch-RSGF-Grad'
    ...
    model = ClassificationSamplerFullyQuantumFFQNN8x8Image(
        gradient_estimator_batchsize=GRADIENT_ESTIMATOR_BATCHSIZE,
