...
if __name__ == '__main__':
    ...
    task_name = 'classification-sklearn-digits-8x8-samplerResetPoolingQRNN-4x4-patch-RSGF-Grad'
    ...
    parser.add_argument('--gradient_estimator_batchsize', type=int, required=False, default=1)
    ...
    model = ClassificationSamplerSimpleQRNNResetPooling8x8Image(
